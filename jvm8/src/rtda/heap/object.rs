...
impl Object{
    ...
    pub fn new(class: Arc<RwLock<Class>>) -> Arc<RwLock<Object>> {
        ...
        Arc::new(RwLock::new(Self { class: class, fields, datas: Default::default() }))
    }
    ...
    pub fn new_array(class: Arc<RwLock<Class>>, len: usize) -> Arc<RwLock<Object>> {
        ...
        let array = match class_name[1] {
            b'Z' | b'B' => Self { class: class, fields: Default::default(), datas: ArrayDatas::Bytes(vec![0;len])},
            b'C' => Self { class: class, fields: Default::default(), datas: ArrayDatas::Chars(vec![0;len])},
            b'S' => Self { class: class, fields: Default::default(), datas: ArrayDatas::Shorts(vec![0;len])},
            b'I' => Self { class: class, fields: Default::default(), datas: ArrayDatas::Ints(vec![0;len])},
            b'J' => Self { class: class, fields: Default::default(), datas: ArrayDatas::Longs(vec![0;len])},
            b'F' => Self { class: class, fields: Default::default(), datas: ArrayDatas::Floats(vec![0f32;len])},
            b'D' => Self { class: class, fields: Default::default(), datas: ArrayDatas::Doubles(vec![0f64;len])},
            _=>Self { class: class, fields: Default::default(), datas: ArrayDatas::Refs(Slots::new(len))},
        };
