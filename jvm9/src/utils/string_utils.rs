...
pub fn get_string_from_slot(loader: Arc<RwLock<ClassLoader>>,slot: &Slot) -> String {
    if let Slot::Ref(j_str_obj) = slot {
    ...
    panic!("slot中存的不是java string")
}

/// 从rust string 得到java 的String 对象
pub fn get_java_string(loader: Arc<RwLock<ClassLoader>>, r_str: Arc<String>) -> Arc<RwLock<Object>> {
