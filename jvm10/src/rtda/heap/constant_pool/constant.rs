...
impl Constant {
    ...
    pub fn new(_: Arc<RwLock<Class>>,cp: Arc<RwLock<ConstantPool>>,info: &ConstantInfo) -> Self {
        ...
        match info {
            ...
            ConstantInfo::NameAndType(_) => Constant::NameAndType(),
            ConstantInfo::MethodHandle(_) => Constant::MethodHandle(),
            ConstantInfo::MethodType(_) => Constant::MethodType(),
            ConstantInfo::InvokeDynamic(_) => Constant::InvokeDynamic(),
